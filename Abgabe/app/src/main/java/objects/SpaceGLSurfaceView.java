        ...
        private void updateObstacles(float fracSec) {
            ...
            for (Obstacle obstacle : obstacles) {
                if (areColliding(ship, obstacle)) {
                    ...
                    if(obstacle instanceof Starship){
                        if(ship.getRingHealth()>0.0f) {
                            ship.resetHealth();
                        }
                        //TODO Lebensenergie auffüllen
                    }
                }
            }
            // remove obsolete obstacles
                ...
                for(int j=i+1; j<=obstacles.size()-1; j++) {
                    ...
                    if(areColliding(obstacle, otherObstacle)) {
                        ...
                        if(obstacle.getClass() == otherObstacle.getClass()) {
                            ...
                            else if(obstacle instanceof Asteroid && otherObstacle instanceof Starship){
                                cv1[0] = cvt1[0] - cvz1[0] + cvz2[0]*4.0f;
                                cv1[2] = cvt1[2] - cvz1[2] + cvz2[2]*4.0f;
                            }
                            else if(otherObstacle instanceof Asteroid && obstacle instanceof Starship){
                                cv2[0] = cvt2[0] - cvz2[0] + cvz1[0]*4.0f;
                                cv2[2] = cvt2[2] - cvz2[2] + cvz1[2]*4.0f;
                            }
                        }
